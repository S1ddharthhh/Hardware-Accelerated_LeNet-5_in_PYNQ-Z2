...
IMAGE_PATH = "test.png"  # Change this to your image filename
...
def benchmark():
    ...
    # 1. Warmup
    # CPU needs to wake up and PyTorch needs to initialize internal memory
    ...
    label = CLASSES.get(prediction_id, "Unknown")
    ...
    print("="*50)
    print(f"Predicted Class : {prediction_id} -> {label}")
    print("-" * 50)
